...
| `gds-xor.yml` | gds-xor | Per-layer XOR of every `*.gds` changed by a PR: a downloadable XOR GDS plus a PDF report with one page per differing layer, and a PR comment showing the difference area in um^2 |
